...
export const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      "At the start of the scan, the controller copies the state of every physical input into memory. That copy is the input image. Your program reads that copy, not the terminal.",
